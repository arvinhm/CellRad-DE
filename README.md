...
This toolkit is compatible with any size of high-dimensional multiplexed images and MERFISH or Xenium Spatial Transcriptomics or Visium HD (for geometric dosimetry). However, for very large image sizes, we recommend considering using a server cluster to ensure optimal performance.
