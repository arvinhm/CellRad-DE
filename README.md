...
This toolkit is compatible with any high-dimensional multiplexed images of any size. However, for very large image sizes, we recommend considering using a server cluster to ensure optimal performance.
